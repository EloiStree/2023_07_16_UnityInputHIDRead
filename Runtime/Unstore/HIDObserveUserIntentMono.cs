...
public class HIDRef_DeviceButtonUniqueID
{
    ...
    public Intent_ObserverHIDButton m_buttonObserver;
}
...
public class HIDRef_DeviceAxisUniqueID
{
    public string m_uniqueID;
    public string m_booleanName;
    public Intent_ObserverHIDAxis m_axisObserver;
}
...
public class HIDRef_DeviceAxisUniqueIDWithRef
{
    ...
    public string m_booleanName;
    public Intent_ObserverHIDAxis m_axisObserver;
    public HIDAxisChangedReference m_sourceRef;
}
...
{
    public HIDSearchPattern_LookAroundAny m_deviceToObserver;
    public Intent_ObserverHIDButton m_buttonObserver;
    public string m_booleanName;
}
